...
class Climate extends Base {
    ...
    withOccupiedSetback(access=a.ALL) {
        assert(!this.endpoint, 'Cannot add feature after adding endpoint');
        this.features.push(new Numeric('occupied_setback', access).withUnit('°C').withDescription('Offset to be used in the local_temperature'));
        return this;
    }
